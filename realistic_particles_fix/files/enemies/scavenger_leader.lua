...
-- "Suomuhauki"
for content in nxml.edit_file("data/entities/projectiles/grenade_leader.xml", ModTextFileGetContent, ModTextFileSetContent) do
    ...
    if explosion then
        ...
        :set("spark_material", "spark_yellow")
    end
